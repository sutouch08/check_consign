...
class Product extends CI_Controller
{
	...
	{	
		...
		{
			$this->session->set_userdata("product_search_text", $this->input->post("search_text"));
		...
		{
			$rs 	= $this->product_model->get_search_data($this->session->userdata("product_search_text"), $config['per_page'], $this->uri->segment($config['uri_segment']));
			$txt 	= $this->session->userdata("product_search_text");
		}
		else
		{
	...
	{
		$this->session->unset_userdata("product_search_text");
		$this->index();	
	}
